...
Here is a tutorial for using VS Code with python: https://code.visualstudio.com/docs/python/python-tutorial.
You will need to add extensions for VS Code from here: https://marketplace.visualstudio.com/vscode.  You will need the Python and Jupyter extensions created by Microsoft.  I use the Latex Workshop extension created by James Yu.  You will probably also find the Data Wrangler, Excel Viewer, and PDF Viewer extensions useful.
