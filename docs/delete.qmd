## Assignment 1<br>BUSI 520<br>Python for Business Research<br>Jones Graduate School of Business<br>Rice University<br>
...
5. Create a function add_to_bib that takes the pathname of a .bib file as its input.  The function should prompt the user to input
